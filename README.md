A project to practice using webpack and to continue practicing DOM manipulation by dynamically rendering content. I will be using JS to generate the entire contents of the website. 
